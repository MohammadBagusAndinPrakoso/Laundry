...
if (isset($_POST["simpan_member"])) {
    // tampung data input member dari orang yang menginput
...
elseif (isset($_POST["update_member"])) {
    ...
    $sql = "update member set nama_member='$nama_member', alamat='$alamat', jenis_kelamin='$jenis_kelamin', tlp='$tlp' where id_member='$id_member'";
